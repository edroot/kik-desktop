...
from kik_desktop_legacy.kik_thread import KikThread
from kik_desktop_legacy.ui.login_widget import LoginWidget
from kik_desktop_legacy.ui.main_widget import MainWidget, MessageItem, PeerListItem
from kik_desktop_legacy.ui.register_widget import RegisterWidget
...
class KikDesktop(QMainWindow):
    ...
    def save(self):
        ...
        filename = os.path.join(config_dir, 'kik_desktop_legacy.json')
    ...
    def load_config(self):
        ...
        if not os.path.exists(filename):
            print("kik_desktop_legacy.json not found at %s" % filename)
